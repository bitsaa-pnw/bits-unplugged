    ...
    function loadContactCard(idToLoad) {
        ...
        if (foundContact) {
            ...
            if (foundContact.linkedin_id) {
                id_text = getLinkedInIdFromUrl(foundContact.linkedin_id)
                linkedinLink.textContent =id_text;
                linkedinLink.href = `https://www.linkedin.com/in/${id_text}`;
